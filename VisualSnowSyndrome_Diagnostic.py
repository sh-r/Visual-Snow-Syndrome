...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionUser_Manual.triggered.connect(lambda: self.web_link())
        self.actionInformation.triggered.connect(lambda: self.web_link())
...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    def loadImage(self):
        """ This function loads the user selected image
            and uses the setPhoto function
        """
    ...
    def setPhoto(self, image):
        """ This function takes an image as input and converts it to QImage.
        """
        """
        self.tmp = image
    ...
    def brightness_value(self, value):
        """ This function takes a value from the slider
    ...
    def changeBrightness(self, img, value):
        """ This function will take an image and the brightness
    ...
    def changeBlur(self, img, value):
        """ This function will take the img image and blur values as inputs and performs
            blur operation using OpenCV
        """
    ...
    def update(self):
        """ This function will update the photo according to the
            current values and calls setPhoto function.
        """
    ...
    def mouseDoubleClickEvent(self, event):
        """ This function detects if image is double-clicked and accordingly presents
        image in Fullscreen or Default view"""
    ...
    def web_link(self):
        url = QtCore.QUrl('https://github.com/sh-r/Visual-Snow-Syndrome/tree/master/documentation')
